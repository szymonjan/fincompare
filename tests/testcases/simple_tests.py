...
import os
import unittest
from tests.testdata.settings import url_with_credentials
...
class BaseTests(WTFBaseTest):
    ...
    COMPANY_FORM_TITLE = "An welches Unternehmen"
    CONTACT_FORM_TITLE = "geben Sie die Kontaktdaten"
    RESULTS_TABLE_TITLE = "passende Anbieter"
    ...
    def test_valid_request(self):
        ...
        self.assertIn(self.COMPANY_FORM_TITLE, company_search_page.get_form_title())
        ...
        self.assertIn(self.RESULTS_TABLE_TITLE, request_result_page.get_table_title())
